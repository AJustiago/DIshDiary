    ...
    <div class="row">
        ...
        <div class="col-6 my-4">
            <div class="row">
                <div class="col-12">
                    <h2>Ingredients</h2>
                    <div id="ingredients" style="height: auto; background-color: rgba(200, 76, 2, 0.25); border-top: 4px solid #C84C02;">
                        <ul style="list-style-type: disc;" class="py-3">
                            <li class="mt-2">3 pounds center-cut beef tenderloin</li>
                            <li class="mt-2">2 ounces pancetta or bacon, finely chopped (¼ cup)</li>
                            <li class="mt-2">2 tablespoons unsalted butter</li>
                            <li class="mt-2">12 ounces mushrooms, very finely chopped (4 cups)</li>
                            <li class="mt-2">1 shallot, diced</li>
                            <li class="mt-2">2 tablespoons extra-virgin olive oil, plus more for drizzling</li>
                            <li class="mt-2">2 garlic cloves, minced</li>
                            <li class="mt-2">2 teaspoons fresh thyme leaves</li>
                            <li class="mt-2">1 tablespoon dry sherry or dry vermouth</li>
                            <li class="mt-2">Kosher salt and black pepper</li>
                            <li class="mt-2">2 tablespoons Dijon mustard</li>
                            <li class="mt-2">10 to 12 thin slices prosciutto</li>
                            <li class="mt-2">1 large egg</li>
                            <li class="mt-2">16 ounces puff pastry, thawed</li>
                        </ul>
                    </div>
                </div>
                <div class="col-12 mt-3">
                    <h2 style="border-bottom: 4px solid #C84C02;">Similiar Recipe</h2>
                    <div class="card">
                        <div class="row no-gutters">
                            <div class="col-md-4">
                                <img src="../../assets/img/Guiness_Pig.jpeg" class="card-img" alt="Card image">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <div class="row">
                                    ...
                                    <p class="card-text" style="font-weight: light; font-size: 14px">hidangan klasik dengan daging sapi empuk, sayuran segar, dan saus kental berbahan dasar bir Guinness. Dibungkus dengan kulit pastry renyah, pie ini menghadirkan perpaduan sempurna antara tekstur dan cita rasa. Cocok untuk makan malam atau berkumpul bersama.</p>
        ...
        <div class="col-6 my-4">
            <h2>Directions</h2>
            <div style="border-top: 4px solid #C84C02;">
                <p><br>Step 1</p>
                <span>
                ...
                <p><br>Step 6</p>
                <span>
                    On a clean work surface, overlap long sheets of plastic wrap (about 15-by-15 inches). Place prosciutto slices on top to make about a 14-by-7-inch rectangle, arranging them in an even layer and overlapping the pieces slightly. Spread cooled mushroom mixture on top. <br>
                </span>
                <p><br>Step 7</p>
                <span>
